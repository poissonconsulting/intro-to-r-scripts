...
x <- c(3L, 0L, 4L, 2L, 5L, 200L)
# this accesses the 2nd value in the vector
x[2]

# How would you access the `4L` value?


# this accesses the 2nd to 4th value
x[2:4]

# Can you select from the 2nd to 6th value in x?
